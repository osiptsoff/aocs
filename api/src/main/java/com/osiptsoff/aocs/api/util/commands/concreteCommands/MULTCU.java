...
public class MULTCU extends RegConstCommand {
    public MULTCU(int R0, int R1, int DISP) {
        super(0b1110, R0, R1, DISP);
    }
    @Override
    ...
    /**
     * <p>Multiplication of unsigned integer by constant.</p>
